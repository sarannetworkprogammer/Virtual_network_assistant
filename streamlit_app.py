...
def main():
    ...
    with st.sidebar:
        ...
        chunk_size = st.sidebar.slider("Chunk Size", min_value=20, max_value=10000, step=10, value=2000)
        chunk_overlap = st.sidebar.slider("Chunk overlap", min_value=5, max_value=10000, step=10, value=200)
